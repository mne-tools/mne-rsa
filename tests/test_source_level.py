...
from mne_rsa import rdm_nifti, rdm_stcs, squareform, rsa_stcs
...
class TestStcRDMs:
    ...
    def test_rdm_spatio_temporal(self):
        ...
        stcs, src, y = make_stcs()
        rdms = list(
            rdm_stcs(stcs, src=src, y=y, spatial_radius=0.05, temporal_radius=0.1)
        )
